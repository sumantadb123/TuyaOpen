...
#define TUYA_OPENSDK_UUID    "uuidfccd9327032f5a2c"             // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY "909xSbtLNhqHivbVjvfTm53D1p28C9F6" // Please change the correct authkey
